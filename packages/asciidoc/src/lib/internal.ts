...
const HighlightJSLanguages = z.enum([
  '1c',
  'abnf',
  'accesslog',
  'actionscript',
...
const HighlightJSThemes = z.enum([
  'a11y-dark',
  'a11y-light',
  'agate',
  'an-old-hope',
...
const asciidocGlobalVariablesSchema = z
  .object({
    ...
    highlightjsTheme: HighlightJSThemes,
    HighlightjsLanguages: HighlightJSLanguages.or(HighlightJSLanguages.array()),
  })
  .or(
    z.object({
