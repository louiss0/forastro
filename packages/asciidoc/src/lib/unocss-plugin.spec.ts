    ...
    describe("Testing getCSSWithSelectorName", () => {
        ...
        test("css output is what is expected", () => {
            ...
            expect(result).toMatchInlineSnapshot(`
              ...
              .prose :where(a:hover):not(:where(.not-prose,.not-prose *)),:where( a:focus):not(:where(.not-prose,.not-prose *)),:where( a:active):not(:where(.not-prose,.not-prose *)) {
              ...
              .prose :where(h1 > small):not(:where(.not-prose,.not-prose *)),:where( h2 > small):not(:where(.not-prose,.not-prose *)),:where( h3 > small):not(:where(.not-prose,.not-prose *)),:where( h4 > small):not(:where(.not-prose,.not-prose *)),:where( h5 > small):not(:where(.not-prose,.not-prose *)) {
              font-size:60%;
              padding:var(--faa-prose-space-2) var(--faa-prose-space-4);
              }


              .prose :where(code):not(:where(.not-prose,.not-prose *)),:where( kbd):not(:where(.not-prose,.not-prose *)),:where( pre):not(:where(.not-prose,.not-prose *)),:where( samp):not(:where(.not-prose,.not-prose *)) {
              font-size:var(--faa-prose-step-neg-1);
              }
              ...
              .prose :where(ul):not(:where(.not-prose,.not-prose *)),:where( ol):not(:where(.not-prose,.not-prose *)),:where( dl):not(:where(.not-prose,.not-prose *)) {
              line-height:'1.6';
              ...
              .prose :where(ul li ul):not(:where(.not-prose,.not-prose *)),:where( ul li ol):not(:where(.not-prose,.not-prose *)),:where( ol li ul):not(:where(.not-prose,.not-prose *)),:where( ol li ol):not(:where(.not-prose,.not-prose *)) {
              ...
              .prose :where(#header):not(:where(.not-prose,.not-prose *)),:where( #content):not(:where(.not-prose,.not-prose *)),:where( #footnotes):not(:where(.not-prose,.not-prose *)),:where( #footer):not(:where(.not-prose,.not-prose *)) {
              width:100%;
              max-width:62.5rem;
              position:relative;
              ...
              .prose :where(blockquote):not(:where(.not-prose,.not-prose *)),:where( quote p):not(:where(.not-prose,.not-prose *)) {
              line-height:'1.6';
              }
              ...
              .prose :where(thead th):not(:where(.not-prose,.not-prose *)),:where( thead td):not(:where(.not-prose,.not-prose *)),:where( tfoot th):not(:where(.not-prose,.not-prose *)),:where( tfoot td):not(:where(.not-prose,.not-prose *)) {
              ...
              .prose :where(th):not(:where(.not-prose,.not-prose *)),:where( td):not(:where(.not-prose,.not-prose *)) {
              ...
              .prose :where(pre.nobreak):not(:where(.not-prose,.not-prose *)),:where( :not(pre).nobreak):not(:where(.not-prose,.not-prose *)) {
              word-wrap:normal;
              }


              .prose :where(pre.nowrap):not(:where(.not-prose,.not-prose *)),:where( :not(pre).nowrap):not(:where(.not-prose,.not-prose *)) {
              white-space:nowrap;
              }


              .prose :where(pre.pre-wrap):not(:where(.not-prose,.not-prose *)),:where( :not(pre).pre-wrap):not(:where(.not-prose,.not-prose *)) {
              white-space:pre-wrap;
              }
