...
function generateBaseLayout(): string {
  return `---
...
function generateDocsLayout(): string {
  return `---
// Generated by @forastro/nx-astro-plugin:layout
export interface Props {
  title: string;
...
export default async function generator(tree: Tree, options: Schema) {
  ...
  if (!tree.exists(filePath)) {
    ...
    switch (layoutType) {
      case 'blog':
        contents = generateBlogLayout();
        break;
      case 'docs':
        contents = generateDocsLayout();
        break;
      case 'marketing':
        contents = generateMarketingLayout();
        break;
      default:
        contents = generateBaseLayout();
    }
