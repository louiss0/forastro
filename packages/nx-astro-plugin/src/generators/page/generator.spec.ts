...
describe('page generator', () => {
  ...
  describe('layout support', () => {
    ...
    it('calculates nested page layout imports and filenames', async () => {
      await generator(tree, {
        project: 'site',
        name: 'about/team',
        directory: 'company',
        layout: 'shared/base-layout',
      });
  ...
  describe('page content', () => {
    it('includes title and description for static pages', async () => {
      ...
      expect(content).toContain(
        'const description = "Services page description"',
      );
    });
    ...
    it('renders content with Content component for dynamic pages', async () => {
      ...
      const content = writeSpy.mock.calls[0][1];
      expect(content).toContain('const { Content } = await render(entry);');
  ...
  describe('dynamic pages', () => {
    it('creates a dynamic page with getStaticPaths', async () => {
      ...
      expect(content).toContain('params: { slug: entry.id }');
