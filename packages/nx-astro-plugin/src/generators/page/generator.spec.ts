...
describe('page generator', () => {
  ...
  describe('static pages', () => {
    it('creates a static page file at src/pages/<name>.astro', async () => {
      ...
      expect(content).toContain('// Generated by @forastro/nx-astro-plugin:page (static)');
  ...
  describe('dynamic pages', () => {
    it('creates a dynamic page with getStaticPaths', async () => {
      ...
      expect(content).toContain('// Generated by @forastro/nx-astro-plugin:page (dynamic)');
    ...
    it('wraps page name in brackets for dynamic pages', async () => {
      await generator(tree, { project: 'site', name: 'post-id', type: 'dynamic' });
    ...
    it('supports directory option for dynamic pages', async () => {
      await generator(tree, { project: 'site', name: 'id', type: 'dynamic', directory: 'blog' });
